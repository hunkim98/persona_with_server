...
const mask7 = [
  {
    ...
    info: [
      ...
      "새로운 경험에 마음이 열려 있기 때문에 다양한 분야에 대한 해박한 지식을 갖고 있다",
    ],
  },
  {
    type: "bad",
...
const mask9 = [
  ...
  },
  {
    type: "bad",
    info: [
      "현실에 깊이 영향을 받고 싶어 하지 않아 스스로가 나서서 활동적으로 살고 싶어하지 않는다",
      "외부적으로 보면 많은 일을 하고 있는 것처럼 보이지만, 실제 중요한 문제를 처리하는 일을 미루는 경향이 있다",
